...
const Footer = () => {
  return (
    <footer className="px-4 pt-12 pb-8 pt-[100px] ">
        <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
            ...
            <div className="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                <ul className="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li className="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-500 uppercase md:mt-0">
                        Product</li>
                    <li><a href="#_"
                ...
                <div className="flex flex-col w-full text-gray-700">
                    <div className="inline-block px-3 py-2 mt-5 font-bold text-gray-500 uppercase md:mt-0">Follow Us</div>
        ...
        <div className="pt-4 pt-6 mt-10 text-center text-gray-600 ">© 2024 DevBuddies. All rights
            reserved.</div>
