    ...
    return(
        ...
        <div
            ...
            <a href="/" className="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span className="ml-3 text-xl text-gray-200 ">DevSage<span className="text-pink-500">.</span></span>
            </a>

            <nav id="nav"
                className="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-200 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
                <a href="#"
                ...
                <div className="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                    <Link href="/sign-in" className="w-full py-2 font-bold text-center text-pink-500">Login</Link>
                </div>
            </nav>
            ...
            <div
                ...
                <Link href="/sign-in"
                    className="relative z-40 px-3 py-2 mr-0 text-sm font-bold text-pink-500 md:px-5 lg:text-white sm:mr-3 md:mt-0">
                        <Button variant='outline' style={{width:'150px',height:'40px',color:'whitesmoke',cursor:'pointer'}}>Login</Button>
                        </Link>
